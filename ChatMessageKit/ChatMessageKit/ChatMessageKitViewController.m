//
//  ChatMessageKitViewController.m
//  ChatMessageKit
//
...
#import "ChatMessageKitViewController.h"
#import "AudioPlayerHelper.h"
@interface ChatMessageKitViewController ()<AudioPlayerHelperDelegate>
...
@implementation ChatMessageKitViewController
...
- (Message *)getPhotoMessageWithBubbleMessageType:(BubbleMessageType)bubbleMessageType {
    Message *photoMessage = [[Message alloc] initWithPhoto:nil thumbnailUrl:@"https://ss1.baidu.com/-4o3dSag_xI4khGko9WTAnF6hhy/image/h%3D360/sign=85c7a9d07fec54e75eec1c18893a9bfd/314e251f95cad1c8037ed8c97b3e6709c83d5112.jpg" originPhotoUrl:nil sender:@"Jack" timestamp:[NSDate date]];
...
- (Message *)getVideoMessageWithBubbleMessageType:(BubbleMessageType)bubbleMessageType {
    ...
    Message *videoMessage = [[Message alloc] initWithVideoConverPhoto:[UIImage imageNamed:@"MessageVideoPlay"] videoPath:nil videoUrl:videoUrl sender:@"Jayson" timestamp:[NSDate date]];
...
- (void)viewDidLoad
{
    ...
    for (NSString *plugIcon in plugIcons) {
        ShareMenuItem *shareMenuItem = [[ShareMenuItem alloc] initWithNormalIconImage:[UIImage imageNamed:plugIcon] title:[plugTitle objectAtIndex:[plugIcons indexOfObject:plugIcon]]];
