...
EmotionManagerViewDelegate,
EmotionManagerViewDataSource
>
 ...
 *  用户输入方式
 */
@property (nonatomic, assign, readonly) InputViewType extViewInputViewType;
 ...
 *  用于显示消息的TableView
 */
@property (nonatomic, weak, readonly) MessageTableView *messageTableView;
