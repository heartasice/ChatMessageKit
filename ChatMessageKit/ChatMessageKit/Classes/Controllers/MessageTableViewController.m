...
@property (nonatomic, weak, readwrite) MessageTableView *messageTableView;
...
- (void)initilzer {
    ...
    MessageTableView *messageTableView = [[MessageTableView alloc] initWithFrame:self.view.bounds style:UITableViewStylePlain];
    ...
    CGFloat inputViewHeight = (self.inputViewStyle == MessageInputViewStyleFlat) ? 45.0f : 40.0f;
...
- (void)didSelecteEmotion:(YYImage *)emotion atIndexPath:(NSIndexPath *)indexPath {
    
#pragma TODO emotionPath
