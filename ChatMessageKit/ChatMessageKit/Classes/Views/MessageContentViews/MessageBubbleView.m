...
@property (nonatomic, weak, readwrite) YYAnimatedImageView *emotionImageView;
...
//    CGSize maxSize = CGSizeMake(lbWidth, MAXFLOAT);
    ...
    switch (message.messageMediaType) {
        ...
        case BubbleMessageMediaTypeEmotion:
            ...
            if (message.emotionPath) {
                ...
                YYImage *animatedImage = [YYImage imageWithData:animatedData];//[[UIImageView alloc] initWithAnimatedGIFData:animatedData];
                _emotionImageView.image = animatedImage;
            }
            break;
        case BubbleMessageMediaTypeLocalPosition:
...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        if (!_bubbleImageView) {
            //bubble image
            YYAnimatedImageView *bubbleImageView = [[YYAnimatedImageView alloc] init];
        ...
        if (!_emotionImageView) {
            YYAnimatedImageView *emotionImageView = [[YYAnimatedImageView alloc] initWithFrame:CGRectZero];
        ...
        if (!_voiceUnreadDotImageView) {
            NSString *voiceUnreadImageName = [[ConfigurationHelper appearance].messageTableStyle objectForKey:kMessageTableVoiceUnreadImageNameKey];
